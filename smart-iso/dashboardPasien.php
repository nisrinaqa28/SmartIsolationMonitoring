...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
     <h1 class="h3 mb-0 text-gray-800">Data Kesehatan : <?php echo $nama_pasien?></h1>
</div>


    <!-- Content Row -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <a href="https://api.whatsapp.com/send?phone=62895330960425"><button>Hubungi Petugas Puskesmas</button></a>
    </div>
    <div class="row">
    ...
    <center>
        <a href="indexPasien.php?content=grafik_harian_pasien.php"><button>Tampilkan Grafik Harian</button></a> &emsp;  &emsp;  &emsp;
        <a href="indexPasien.php?content=grafik_total_pasien.php"><button>Tampilkan Grafik Total</button></a>
        </center>
</html>
