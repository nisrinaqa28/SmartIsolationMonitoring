...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <center>
        <a href="index.php?content=grafik_harian_dashboard.php"><button>Tampilkan Grafik Harian</button></a> &emsp;  &emsp;  &emsp;
        <a href="index.php?content=grafik_total_dashboard.php"><button>Tampilkan Grafik Total</button></a>
        </center>
</html>
